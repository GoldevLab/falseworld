/** False World meadow WebGPU v196 — FPV camera at neck (Rust-style look-down). */
/**
...
`;
  ...
  async function create(canvas, opts) {
    ...
    function cameraMatrices() {
      ...
      const near = camMode === "fpv" ? Math.max(NEAR, 0.18) : NEAR;
    ...
    function getPose() {
      ...
      return {
        ...
        // FPV: slightly larger near plane clips residual collar/shoulder shell
        near: camMode === "fpv" ? Math.max(NEAR, 0.18) : NEAR,
        far: FAR,
      };
    }
