...
@vertex fn vs_grass(
  ...
  // tip #2e698c, base #000, AO power ~5
...
@fragment fn fs_grass(input : GrassOut) -> @location(0) vec4f {
  ...
  let R = reflect(-V, n);
  let sky = mix(vec3f(0.05, 0.07, 0.10), vec3f(0.35, 0.45, 0.65), max(R.y, 0.0));
  let env = sky * (0.28 + 0.5 * input.height_t);

  let shade = 0.32 + ndl * 0.9;
        ...
        colorAttachments: [
          {
            ...
            clearValue: { r: 0.04, g: 0.07, b: 0.12, a: 1 },
            loadOp: "clear",
            storeOp: "store",
          },
        ],
