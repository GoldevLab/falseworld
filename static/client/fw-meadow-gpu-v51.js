/** False World meadow WebGPU v51 — snow mountain relief + slope rock tint. */
/**
      ...
      for (let py = 0; py < size; py++) {
        ...
        for (let px = 0; px < size; px++) {
          ...
          if (edge > 0.42) {
            ...
            data[o] = (c[0] * (1 - beach) + 170 * beach) | 0;
            data[o + 1] = (c[1] * (1 - beach) + 145 * beach) | 0;
            data[o + 2] = (c[2] * (1 - beach) + 90 * beach) | 0;
            data[o + 3] = 255;
          }
        }
      }
    ...
    function update(dt) {
      ...
      // HUD biome stamp (~4 Hz)
      {
        ...
        if (((t / 250) | 0) !== ((lastHudBiome / 250) | 0)) {
          ...
          const kmZ = (player.z / 1000).toFixed(2);
          onHud({
            status: "b77 · " + BIOME_NAMES[bid] + " · " + kmX + "," + kmZ + " km",
          });
        }
      }
