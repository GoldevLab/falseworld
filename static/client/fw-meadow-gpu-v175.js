/** False World meadow WebGPU v175 — melee gather fix (3rd-person camera range). */
/**
...
`;
  ...
  async function create(canvas, opts) {
    ...
    function tryHarvestAimed() {
      ...
      // Prefer camera aim, but require node within melee of the avatar
